  ...
  return (
    <>
      ...
      <PageHeader
        ...
        image={imagePath('/images/ecd-child-painting.jpg')}
        imageWebp={imagePath('/images/ecd-child-painting.webp')}
        imageWebp800w={imagePath('/images/ecd-child-painting-800w.webp')}
        imageWidth={1280}
        imageHeight={1920}
      />
      ...
      <section className="section-pad">
        <div className="container-px grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
          ...
          <StockPhoto
            src={imagePath('/images/ecd-child-painting.jpg')}
            webpSrc={imagePath('/images/ecd-child-painting.webp')}
